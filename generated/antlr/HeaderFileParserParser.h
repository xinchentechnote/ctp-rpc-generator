...
public:
  enum {
    ...
    T__14 = 15, IDENTIFIER = 16, IFENDIFDECLARATION = 17, PRAGMADECLARATION = 18, 
    INCLUDEDECLARATION = 19, IFDECLARATION = 20, ENDIFDECLARATION = 21, 
    COMMENT = 22, WHITESPACE = 23
  };
  ...
  enum {
    ...
    RuleParameterList = 9, RuleParameter = 10, RuleType = 11, RuleMacroConstantDeclaration = 12
  };
  ...
  class TypeContext;
  class MacroConstantDeclarationContext; 
  ...
  public:
    ...
    MacroConstantDeclarationContext *macroConstantDeclaration();
  ...
  class  MacroConstantDeclarationContext : public antlr4::ParserRuleContext {
  public:
    MacroConstantDeclarationContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *IDENTIFIER();
